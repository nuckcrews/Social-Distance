...
func DefaultInvitePresenters(presentingController: UIViewController) -> [InvitePresenter] {
  let url = URL(string: "https://distance.page.link/Home")!
  return [
    EmailInvitePresenter(
      content: InviteContent(
        subject: "Help stop the spread of Covid-19",
        body: "Download DISTANCE to maintain Social DIstance as we fight to stop the spread of Covid-19. ",
        link: url
      )
    ...
    SocialDeepLinkInvitePresenter(
      content: InviteContent(
        subject: nil,
        body: "Help stop the spread of Covid-19! Download DISTANCE to maintain Social DIstance. ",
        link: url
      ),
      presentingController: presentingController
    ),
